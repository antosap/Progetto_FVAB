...
from mediap_util import REYE,LEYE
...
def landmark(path):
    ...
    for i, file in enumerate(path):
        ...
        # creo i csv
        pathFile = "test_32_sogg/csv_landmark/Eyes_csv_landmark/" + fileName + ".csv"
...
# eseguire manualmente su 2 cartelle per volta per evitare errore di memoria fino a soluzione contraria.
# landmark(pathList[8])
